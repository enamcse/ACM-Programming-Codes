/**
* E:\Dropbox\Code\Codeforces\550A.cpp
* Created on: 2016-04-02-07.38.59, Saturday
* Verdict: Not Solved
...
//    begin = clock();
    ...
    bool ab=false, ba=false, ghotona = false;
    string s;
    w=x=y=z=-1;
    cin>>s;
    n = s.size();
    ...
    cerr<<ab<<ba<<ghotona<<endl;
    if(w==-1||x==-1||(abs(w-z)==1&&abs(x-y)==1)) cout<<"NO";
    else cout<<"YES";
