...
//                cout<<p[2+j].first<<":"<<p[2+j].second<<endl;


                if(p[i].first>p[2+j].second) attc = 1;
                else if(p[i].first<p[2+j].second) attc = 2;
                else attc = 0;

                if(p[i].second>p[2+j].first) deff = 1;
                else if(p[i].second<p[2+j].first) deff = 2;
                else deff = 0;
