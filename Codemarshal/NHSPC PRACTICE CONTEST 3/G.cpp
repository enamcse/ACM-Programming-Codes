/**
* H:\Dropbox\Code\Codemarshal\NHSPC PRACTICE CONTEST 3\G.cpp
* Created on: 2015-05-16-01.30.04, Saturday
* Verdict: Solved
...
//    begin = clock();
    ...
    matrix ans=bigmod(base,n-2,2); //n-number of baseconditions+1
    printf("%lld\n", ans.x[1][1]);
